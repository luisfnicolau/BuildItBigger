 ...
 * on 2016-01-17 at 15:17:51 UTC 
 * Modify at your own risk.
 */

package com.example.luis.myapplication.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "myJoke".
   *
   * This request holds the parameters needed by the myApi server.  After setting any optional
   * parameters, call the {@link MyJoke#execute()} method to invoke the remote operation.
   *
   * @return the request
   */
  public MyJoke myJoke() throws java.io.IOException {
    MyJoke result = new MyJoke();
    initialize(result);
    return result;
  }

  public class MyJoke extends MyApiRequest<com.example.luis.myapplication.backend.myApi.model.MyJokes> {
     ...
     * parameters, call the {@link MyJoke#execute()} method to invoke the remote operation. <p> {@link
     * MyJoke#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)} must
     * be called to initialize this instance immediately after invoking the constructor. </p>
     *
     * @since 1.13
     */
    protected MyJoke() {
      super(MyApi.this, "POST", REST_PATH, null, com.example.luis.myapplication.backend.myApi.model.MyJokes.class);
    }

    @Override
    public MyJoke setAlt(java.lang.String alt) {
      return (MyJoke) super.setAlt(alt);
    }

    @Override
    public MyJoke setFields(java.lang.String fields) {
      return (MyJoke) super.setFields(fields);
    }

    @Override
    public MyJoke setKey(java.lang.String key) {
      return (MyJoke) super.setKey(key);
    }

    @Override
    public MyJoke setOauthToken(java.lang.String oauthToken) {
      return (MyJoke) super.setOauthToken(oauthToken);
    }

    @Override
    public MyJoke setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (MyJoke) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public MyJoke setQuotaUser(java.lang.String quotaUser) {
      return (MyJoke) super.setQuotaUser(quotaUser);
    }

    @Override
    public MyJoke setUserIp(java.lang.String userIp) {
      return (MyJoke) super.setUserIp(userIp);
    }

    @Override
    public MyJoke set(String parameterName, Object value) {
      return (MyJoke) super.set(parameterName, value);
    }
  }
  ...
  public class SayHi extends MyApiRequest<com.example.luis.myapplication.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.example.luis.myapplication.backend.myApi.model.MyBean.class);
